...
export const Week = (props: WeekType) => {
  ...
  moment.range(startOfWeek, endOfWeek).by("days", (day: moment) => {
    ...
    const style = [
      ...
      date === null && day.format("DD") === moment().format("DD")
        ? styles.daySelected
        : ""
    ];
    ...
    return (
      <View style={styles.calendar}>
        <View style={styles.heading}>
          ...
          <Text
            style={{ fontFamily: "Poppins", fontSize: 15, fontWeight: "bold" }}
          >
        ...
        <Month
          ...
          focusedInput={
            this.props.focusedInput ? this.props.focusedInput : "endDate"
          }
